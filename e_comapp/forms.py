...
class RegisterForm(forms.ModelForm):
    ...
    def clean(self):
        ...
        if password != password_check:
            raise forms.ValidationError('Введенные пароли не совпадают! Попробуйте снова!')
...
class OrderForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['date'].help_text = 'Доставка производится на следующий день после оформления заказа. Менеджер свяжется с Вами.'
