...
from e_comapp.forms import OrderForm, RegisterForm, LoginForm
from e_comapp.models import Category, Product, Cart, CartItem, Order
...
def make_order_view(request):
    ...
    if form.is_valid():
        ...
        return render(request, 'thank_you.html', {'cart': cart})
